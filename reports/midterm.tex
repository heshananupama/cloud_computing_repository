...
In the case of RUBiS, the benchmark was run three times. Like gbmperf, CPU and memory utilization was averaged and graphed. As the benchmark runs longer than gbmperf, we set the period to 5 minutes as we tried to retrieve the metrics with CloudWatch-dump.
